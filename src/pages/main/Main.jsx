  ...
  return (
    ...
    >
      ...
      <div className="w-full sm:p-12">
        ...
        <h1 className="text-[2.4em] font-bold -mt-3 whitespace-nowrap sm:text-[3em] md:text-[3.6em]">{MAIN.user}</h1>
        ...
        <p className="text-[1em] sm:text-[1.4em] md:text-[1.8em] md:max-w-[80%]">{MAIN.descrip}</p>
      </div>
