...
export default function Language() {
  ...
  return (
    <select
      ...
      className="block bg-main rounded-md shadow w-full max-w-[150px] py-2 md:px-3 cursor-pointer hover:text-hv-main leading-tight focus:outline-none focus:shadow-outline"
    >
